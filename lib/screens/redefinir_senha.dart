...
class RedefinirSenhaPrincipal extends StatefulWidget {
  const RedefinirSenhaPrincipal({Key? key}) : super(key: key);

  @override
  _RedefinirSenhaPrincipalState createState() =>
      _RedefinirSenhaPrincipalState();
}

class _RedefinirSenhaPrincipalState extends State<RedefinirSenhaPrincipal> {
